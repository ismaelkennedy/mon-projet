            ...
            switch (choix) {
                ...
                case 4:
                    ...
                    for (Professeur professeur : professeurs) {
                        System.out.println("Nom et prénoms: " + professeur.getNomCompletp());
                        System.out.println("***********************************");
                    }
                    break;
                case 5:
                    ...
                    Classe classeProfList = classeService.rechercheClasseParLibelle(libelleClasse);
                    if (classeProfList != null) {
                        List<Professeur> professeursClasse = professeurService.listerProfesseursParClasse(libelleClasse);
                        if (!professeursClasse.isEmpty()) {
                            for (Professeur profClasse : professeursClasse) {
                                System.out.println("Nom et prénoms: " + profClasse.getNomCompletp());
                                System.out.println("Grade: " + profClasse.getGrade());
                                System.out.println("***********************************");
                            }
                        } else {
                            System.out.println("Aucun professeur trouvé pour cette classe.");
                        }
                    } else {
                ...
                case 10:
                    ...
                    professeurClasse.setProfesseur(profClasse); 

                    professeurService.ajouterProfesseurClasse(professeurClasse);
                    System.out.println("Le professeur " + professeurClasse.getProfesseur().getNomCompletp()
                            + " a été ajouté à la classe " + professeurClasse.getClasse().getLibelle() + " avec succès");
                    break;
                case 11:
                    ...
                    etudiantClasse.setEtudiant(etuClasse); 

                    etudiantService.ajouterEtudiantClasse(etudiantClasse);

                    System.out.println("L'étudiant " + etudiantClasse.getEtudiant().getNomComplet()
                            + " a été ajouté à la classe avec succès dans la classe " + classeE.getLibelle());
